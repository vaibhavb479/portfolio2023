      ...
      <Wrapper>
        ...
        <Div className="mb-10 relative">
          ...
          <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-black text-center max-w-[1000px] mx-auto">
            Let's start the conversation about your requirements. Your digital
            goals are important to us, and we're here to listen, understand, and
            craft the perfect solution that aligns with your vision. Get in
