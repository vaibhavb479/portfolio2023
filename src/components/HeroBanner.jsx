      ...
      <Wrapper>
        ...
        >
          <div className="font-light mb-4">
            👋 Hi, I Am <span className="font-semibold">Vaibhav</span>
          </div>
          <div className="max-w-[100%]">
            I specialize in creating and maintaining modern websites and
            applications, crafting digital solutions that are tailored to your
            unique needs. With a passion for problem-solving, I thrive on
            tackling your business challenges head-on, ensuring that your
            digital presence is not just cutting-edge but also aligned with your
