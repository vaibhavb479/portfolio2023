        ...
        <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
          ...
          <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
            <Service
              ...
              desc="Passionate web developer dedicated to crafting modern, user-centric websites that bring your digital dreams to life."
              data={[
                "Prototype",
                "Wireframe",
                "User Experience",
            ...
            <Service
              num="2"
              title="UI/UX Design"
              desc="UI/UX designer with a flair for creating intuitive, visually captivating user experiences that elevate your digital presence."
              data={[
                "Prototype",
                "Wireframe",
                "User Experience",
            ...
            <Service
              ...
              desc="Social media enthusiast committed to boosting your brand's online presence through strategic management and engaging content. Let's connect, engage, and grow together!"
              data={[
                "Marketing",
                "Content Creation",
                "Strategy",
            ...
            <Service
              ...
              desc="Experienced WordPress developer dedicated to bringing your digital vision to life through tailored, user-friendly websites. Let's transform your ideas into a seamless online reality."
              data={[
                "Prototype",
                "Wireframe",
                "User Experience",
